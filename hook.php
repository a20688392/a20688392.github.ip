...
//require_once __DIR__ . '/JoneAutoload.php';
...
try {
    ...
    TelegramLog::initialize(
        new Logger('telegram_bot', [
            (new StreamHandler($config['logging']['debug'], Monolog\Logger::DEBUG))->setFormatter(new Monolog\Formatter\LineFormatter(null, null, true)),
            (new StreamHandler($config['logging']['error'], Monolog\Logger::ERROR))->setFormatter(new Monolog\Formatter\LineFormatter(null, null, true)),
        ]),
    ...
    //$message = new Longman\TelegramBot\Entities\Update();            // Get Message object
    //file_put_contents('/var/www/html/telegram.log', $logMessage, FILE_APPEND);
